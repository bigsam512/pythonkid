...
def within_y(co1, co2):
    if (
        (co1.y1 > co2.y1 and co1.y1 < co2.y2)
...
class Stickman(Sprite):
    def __init__(self, game):
        Sprite.__init__(self, game)
        self.images_left = [
            PhotoImage(file="L11.gif"),
            PhotoImage(file="L12.gif"),
            PhotoImage(file="L13.gif"),
        ]
        self.images_right = [
            PhotoImage(file="R11.gif"),
            PhotoImage(file="R12.gif"),
            PhotoImage(file="R13.gif"),
        ]
    ...
    def move(self):
        ...
        print(self.x, self.y, co.x1, co.x2, co.y1, co.y2)
...
if __name__ == "__main__":
    ...
    door = DoorSprite(g, PhotoImage(file="门开.gif"), 45, 30, 40, 35)
